...
import 'package:expense_tracker/pages/contato_detalhes_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        "/contato-cadastro": (context) => const ContatoCadastroPage(),
        "/contato-detalhes": (context) => const ContatoDetalhesPage(),
      },
      initialRoute: "/splash",
    );
  }
